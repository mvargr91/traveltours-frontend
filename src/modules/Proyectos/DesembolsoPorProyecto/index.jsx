...
import DesembolsoPorProyectoCreador from './DesembolsoPorProyectoCreador';
import {onGetColeccion, onDelete } from '../../../@crema/redux/features/proyectoDesembolso/proyectoDesembolsoSlice';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('CrearSimul') >= 0 && (
                <Tooltip title='Crear Simulación DesembolsoPorProyecto' onClick={onOpenAddSimulacionPorProyecto}>
                  <IconButton
...
const DesembolsoPorProyecto = (props) => {
  ...
  const [orderByToSend, setOrderByToSend] = React.useState('fecha_desembolso:asc',);
  ...
  const { rows, desde, hasta, ultima_pagina, total } = useSelector((state) => state.proyectoDesembolso);
      ...
      user.usuario.permisos.forEach((modulo) => {
        modulo.opciones.forEach((opcion) => {
          if (opcion.url === props.route.path) {
            setTitulo(opcion.nombre + '- Desembolsos');
  ...
  const onDeleteProyecto = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar el Desembolso Por Proyecto?',
  ...
  return (
    <div className={classes.root}>
      ...
      {showForm ? 
      (
        <DesembolsoPorProyectoCreador
          showForm={showForm}
          DesembolsoPorProyecto={ProyectoSeleccionado}
          accion={accion}
...
DesembolsoPorProyecto.propTypes = {
...
export default DesembolsoPorProyecto;
