...
import {onGetColeccion, onDelete} from '../../../@crema/redux/features/Proyecto/proyectosSlice';
...
const cells = [
  ...
  {
    id: 'coordenadas_ubicacion',
    typeHead: 'string',
    label: 'Coordenadas Ubicación',
    value: (value) => value,
    align: 'left',
    mostrarInicio: false,
  },
  ...
  {
    id: 'valor_inversion_proyecto',
    typeHead: 'numeric',
    label: 'Valor inversión proyecto',
    value: (value) =>  formatCurrency(value),
    align: 'right',
    mostrarInicio: true,
  },
    {
    id: 'vehiculo_inversion',
    typeHead: 'string',
    label: 'Vehiculo inversión',
    value: (value) => value,
    align: 'left',
    mostrarInicio: false,
  },
    {
    id: 'comunidad_energetica',
    typeHead: 'string',
    label: 'Comunidad energetica',
    value: (value) => value,
    align: 'left',
    mostrarInicio: false,
  },
  ...
  },
  {
    ...
    {
    id: 'porcentaje_mantenimiento',
    typeHead: 'string',
    label: 'Porcentaje mantenimiento',
    value: (value) => value + ' %',
    align: 'left',
    mostrarInicio: false,
  },
    {
    id: 'anios_depreciacion',
    typeHead: 'string',
    label: 'Años depreciasión',
    value: (value) => value + ' %',
    align: 'left',
    mostrarInicio: false,
  },
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Proyecto' onClick={onOpenAddProyecto}>
                  <IconButton
...
const Proyecto = (props) => {
  ...
  const { rows, desde, hasta, ultima_pagina, total } = useSelector((state) => state.proyectos);
  ...
  const onGoDocumentos = (proyecto_id) => {
    navigate('/documentos-proyectos/' + proyecto_id);
  } 

  const onGoActividades = (proyecto_id) => {
    navigate('/actividades-por-proyectos/' + proyecto_id);
  } 
  
  const onGoSimulaciones = (proyecto_id) => {
    navigate('/simulaciones-por-proyectos/' + proyecto_id);
  } 

  const onGoFotos = (proyecto_id) => {
    navigate('/proyectos-fotos/' + proyecto_id);
  }  

  const onGoDesembolsos = (proyecto_id) => {
    navigate('/proyectos-desembolsos/' + proyecto_id);
  }  
                              ...
                              <Box style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                                <CalculateIcon
                                  sx={{'&:hover': {
                                    ...
                                    color: theme.palette.colorFiltro}}
                                  onClick={() => onGoSimulaciones(row.id)}
                            ...
                            <Tooltip title={'Actividades'}>
                              <Box style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                                <FactCheckIcon
                                  ...
                                  color: theme.palette.grayBottoms,}}
                                  onClick={() => onGoActividades(row.id)}
                                  className={`${classes.generalIcons}`}/>
                              </Box>
                            </Tooltip>
                          </StyledTableCell>
                          <StyledTableCell align='center' className={classes.cell}>
                            <Tooltip title={'Desembolsos'}>
                              <Box style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                                <PaymentsIcon
                                  sx={{'&:hover': {
                                      color: theme.palette.colorHovers,
                                  ...
                                  color: "#6a6a6a",}}
                                  onClick={() => onGoDesembolsos(row.id)}
                                  className={`${classes.generalIcons}`}/>
                              </Box>
                            </Tooltip>
                          </StyledTableCell>
