          ...
          <Box px = {{md: 5, lg: 8, xl: 10}}>
                  ...
                  >
                    ...
                    <FormikAutocomplete    
                      options={
                        accion !== 'ver'
                          ? sectoresProyectos.filter((item) => item.estado === 1)
                          : sectoresProyectos
                      }
                      name='id_sector_proyecto'
                      inputValue={initialValues.id_sector_proyecto}
                  ...
                  >
                    <MyCurrencyFieldNumeroDecimal
                      sx={{[theme.breakpoints.up('xl')]: {
                        marginBottom: 5,
                      },
                      paddingRight: 4}}
                      className = {classes.myTextField} 
                      label = 'Generacion anual (kWh)' 
                  ...
                  >
                    {values.indicativo_plan_padrino === 'S' && (
                      <MyCurrencyFieldMoneda
                         sx={{
                        ...
                        className={classes.myTextField}
                        label='Valor inversion externa'
                        name='valor_inversion_proyecto'
                        disabled={disabled}
                        required
                      />
                    )}                    
                    {values.indicativo_plan_padrino === 'S' && (
                      <FormikAutocomplete
                        options={
                          accion !== 'ver'
                            ? categoriasInversiones.filter((item) => item.estado === 1)
                            : categoriasInversiones
                        }
                        sx={{
                          [theme.breakpoints.up('xl')]: { marginBottom: 5 }}}
                  ...
                  >
                    ...
                    <FormikAutocomplete                 
                      options={
                        accion !== 'ver'
                          ? vehiculosInversiones.filter((item) => item.estado === 1)
                          : vehiculosInversiones
                      }
                      sx={{[theme.breakpoints.up('xl')]: {
                        marginBottom: 5,
                      ...
                      paddingRight: 4}}
                      name='id_vehiculo_inversion'
                      inputValue={initialValues.id_vehiculo_inversion}
                      label='Vehiculo inversion *'
                      disabled={disabled}            
                      className={classes.myTextField}
                      variant='standard'
                      fullWidth
                    ...
                    <FormikAutocomplete                 
                      options={
                        accion !== 'ver'
                          ? comunidadesEnergeticas.filter((item) => item.estado === 1)
                          : comunidadesEnergeticas
                      }
                      sx={{[theme.breakpoints.up('xl')]: {
                        marginBottom: 5,
                      ...
                      paddingRight: 4}}
                      name='id_comunidad_energetica'
                      inputValue={initialValues.id_comunidad_energetica}
