    ...
    <>
      ...
      <AppGridContainer>
        <Grid
          ...
          <AppComponentCard title="Tiny Bar Chart" component={TinyBarChart} source={TinyBarChartSource} />
        </Grid>
        <Grid
          size={{
            xs: 12,
          ...
          <AppComponentCard title="Stacked Bar Chart" component={StackedBarChart} source={StackedBarChartSource} />
        </Grid>
        <Grid
          size={{
            xs: 12,
          ...
          <AppComponentCard title="Mix Bar Chart" component={MixBarChart} source={MixBarChartSource} />
        </Grid>
        <Grid
          size={{
            xs: 12,
        ...
        <Grid
          ...
          <AppComponentCard title="Biaxial Bar Chart" component={BiaxialBarChart} source={BiaxialBarChartSource} />
        </Grid>
      </AppGridContainer>
    </>
  );
