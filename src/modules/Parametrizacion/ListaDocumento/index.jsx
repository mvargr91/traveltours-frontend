...
import {onGetColeccion, onDelete} from '../../../@crema/redux/features/ListaDocumento/listaDocumentosSlice';
...
const cells = [
  ...
  },
  {
    ...
    typeHead: 'string',
    label: 'Tipo Lista',
    value: (value) => TIPO_LISTA.map((estado) => estado.id === value ? estado.nombre : ''),
    align: 'left',
    mostrarInicio: true,
  },
  {
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear ListaDocumento' onClick={onOpenAddListaDocumento}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddListaDocumento: PropTypes.func.isRequired,
...
const ListaDocumento = (props) => {
  ...
  const { rows, desde, hasta, ultima_pagina, total } = useSelector((state) => state.listasDocumentos);
