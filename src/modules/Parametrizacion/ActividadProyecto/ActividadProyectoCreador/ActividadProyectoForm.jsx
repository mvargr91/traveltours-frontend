...
import { onGetColeccionLigeraXTipo as onGetactividadProyectos } from '../../../../@crema/redux/features/actividadProyecto/actividadProyectoSlice';
...
const ActividadProyectoForm = (props) => {
  ...
  const { coleccionLigera: actividadProyectos } = useSelector((state) => state.actividadProyecto);
  ...
  useEffect(() => {  
    if(values.id_tipo_proyecto){
      ...
      dispatch(onGetactividadProyectos({id_tipo_proyecto: values.id_tipo_proyecto}));   
        ...
        <Box py={5} px={{ xs: 5, lg: 8, xl: 10 }}>
          ...
          <Box px = {{md: 5, lg: 8, xl: 10}}>                  
                  ...
                  >                    
                    ...
                    />
                    <MyRadioField 
                      label = 'Control fecha vencimiento *' 
                      name = 'Indicativo_fecha_vcmto' 
                      disabled={disabled}
                      required 
                  ...
                  >  
                    <FormikAutocomplete
                      options={
                        accion !== 'ver'
                          ? actividadProyectos.filter((item) => item.estado === 1)
                          : actividadProyectos
                      }
                      sx={{[theme.breakpoints.up('xl')]: {
                        marginBottom: 5,
                      }, paddingRight: 4 }}
                      name="id_actividad_prerequisito"
                      inputValue={initialValues.id_actividad_prerequisito}
                      label="Actividad prerrequisito"
                      disabled={disabled}
                      className={classes.myTextField}
                      variant="standard"
                      fullWidth
...
ActividadProyectoForm.propTypes = {
...
export default ActividadProyectoForm;
