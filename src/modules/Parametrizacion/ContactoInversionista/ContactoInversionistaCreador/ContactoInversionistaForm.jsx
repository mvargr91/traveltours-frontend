...
import { TIPO_CONTACTOS, TIPO_DOCUMENTO } from '../../../../shared/constants/ListaValores';
import {
  ERROR_TYPE,
...
const ContactoForm = (props) => {
  ...
  const { handleOnClose, accion, inversionistas, initialValues, titulo, values, inversionista } = props;
              ...
              <Box px = {{md: 5, lg: 8, xl: 10}}>                
                  ...
                  >                          
                    <FormikAutocomplete      
                      ...
                      options={
                        accion !== 'ver'
                          ? TIPO_CONTACTOS.filter((item) => item.estado === 1)
                          : TIPO_CONTACTOS
                      }
                      name='tipo_contacto'
                      // inputValue={initialValues.id_inversionista}
