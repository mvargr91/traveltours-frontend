...
import ComunidadEnergeticaCreador from './ComunidadEnergeticaCreador';
import {onGetColeccion, onDelete} from '../../../@crema/redux/features/comunidadEnergetica/comunidadEnergeticaSlice';
...
import { TIPO_COMUNIDAD_ENERGETICA, TIPO_DOCUMENTO} from '../../../shared/constants/ListaValores';
...
const cells = [
  {
    ...
    typeHead: 'string',
    label: 'Tipo',
    value: (value) => TIPO_COMUNIDAD_ENERGETICA.map((estado) => estado.id === value ? estado.nombre: ''),
    align: 'left',
    mostrarInicio: false,
  },
    {
    id: 'nombre_comercializador',
    typeHead: 'string',
    ...
    {
    id: 'nombre_rep_principal',
    typeHead: 'string',
    label: 'Nombre Rep. Principal',
    value: (value) => value,
    align: 'left',
    mostrarInicio: false,
  },
    {
    id: 'tipo_documento_rep_ppal',
    typeHead: 'string',
    label: 'Tipo Doc Rep Ppal',
    value: (value) => TIPO_DOCUMENTO.map((estado) => estado.id === value ? estado.nombre: ''),
    align: 'left',
    mostrarInicio: false,
  },
    {
    id: 'numero_documento_rep_ppal',
    typeHead: 'string',
    label: 'Num Rep Ppal',
    value: (value) => value,
    align: 'left',
  ...
  },
  {
    ...
    {
    id: 'tipo_documento_rep_legal',
    typeHead: 'string',
    label: 'Tipo Rep Legal',
    value: (value) => TIPO_DOCUMENTO.map((estado) => estado.id === value ? estado.nombre: ''),
    align: 'left',
    mostrarInicio: false,
  },
    {
    id: 'numero_documento_rep_legal',
    typeHead: 'string',
    label: 'Num Rep Legal',
    value: (value) => value,
    align: 'left',
  ...
  },
  {
    id: 'email_rep_legal',
    typeHead: 'string',
    label: 'Correo Electronico Rep Legal',
    value: (value) => value,
    align: 'left',
    mostrarInicio: false,
  },  
      {
    id: 'nombre_rep_suplente',
    typeHead: 'string',
    label: 'Suplente',
    value: (value) => value,
    align: 'left',
    ...
    id: 'email_rep_supl',
    typeHead: 'string',
    label: 'Correo Electronico Suplente',
    value: (value) => value,
    align: 'left',
    mostrarInicio: false,
  },  
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear ComunidadEnergetica' onClick={onOpenAddComunidadEnergetica}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddComunidadEnergetica: PropTypes.func.isRequired,
...
const ComunidadEnergetica = (props) => {
  ...
  const [ComunidadEnergeticaSeleccionado, setComunidadEnergeticaSeleccionado] = useState(0);
  const { rows, desde, hasta, ultima_pagina, total } = useSelector((state) => state.comunidadEnergetica);
  ...
  const onOpenEditComunidadEnergetica = (id) => {
    setComunidadEnergeticaSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewComunidadEnergetica = (id) => {
    setComunidadEnergeticaSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteComunidadEnergetica = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar la Comunidad Energetica ?',
  ...
  const onOpenAddComunidadEnergetica = () => {
    setComunidadEnergeticaSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper sx={{marginBottom: theme.spacing(2),}} className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddComunidadEnergetica={onOpenAddComunidadEnergetica}
                        ...
                        <StyledTableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEditComunidadEnergetica(row.id)}
                                sx={{'&:hover': {
                                  cursor: 'pointer',
                          ...
                          {permisos.indexOf('Listar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.ver' />}>
                              <VisibilityIcon
                                onClick={() => onOpenViewComunidadEnergetica(row.id)}
                                sx={{'&:hover': {
                                  color: theme.palette.colorHovers,
                                  cursor: 'pointer',
                                },
                          ...
                          {permisos.indexOf('Eliminar') >= 0 && (
                            ...
                            >
                              <DeleteIcon
                                onClick={() => onDeleteComunidadEnergetica(row.id)}
                                sx={{'&:hover': {
                                  color: theme.palette.colorHovers,
                                  cursor: 'pointer',
                                },
      ...
      {showForm ? 
      (
        <ComunidadEnergeticaCreador
          showForm={showForm}
          ComunidadEnergetica={ComunidadEnergeticaSeleccionado}
          accion={accion}
...
export default ComunidadEnergetica;
