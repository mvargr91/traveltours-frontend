...
import VehiculoInversionCreador from './VehiculoInversionCreador';
import {onGetColeccion, onDelete} from '../../../@crema/redux/features/VehiculoInversion/vehiculoInversionSlice';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear VehiculoInversion' onClick={onOpenAddVehiculoInversion}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddVehiculoInversion: PropTypes.func.isRequired,
...
const VehiculoInversion = (props) => {
  ...
  const [VehiculoInversionSeleccionado, setVehiculoInversionSeleccionado] = useState(0);
  const { rows, desde, hasta, ultima_pagina, total } = useSelector((state) => state.vehiculoInversion);
  ...
  const onOpenEditVehiculoInversion = (id) => {
    setVehiculoInversionSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewVehiculoInversion = (id) => {
    setVehiculoInversionSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteVehiculoInversion = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar el vehiculo inversión ?',
  ...
  const onOpenAddVehiculoInversion = () => {
    setVehiculoInversionSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper sx={{marginBottom: theme.spacing(2),}} className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddVehiculoInversion={onOpenAddVehiculoInversion}
                        ...
                        <StyledTableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEditVehiculoInversion(row.id)}
                                sx={{'&:hover': {
                                  cursor: 'pointer',
                          ...
                          {permisos.indexOf('Listar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.ver' />}>
                              <VisibilityIcon
                                onClick={() => onOpenViewVehiculoInversion(row.id)}
                                sx={{'&:hover': {
                                  color: theme.palette.colorHovers,
                                  cursor: 'pointer',
                                },
                          ...
                          {permisos.indexOf('Eliminar') >= 0 && (
                            ...
                            >
                              <DeleteIcon
                                onClick={() => onDeleteVehiculoInversion(row.id)}
                                sx={{'&:hover': {
                                  color: theme.palette.colorHovers,
                                  cursor: 'pointer',
                                },
      ...
      {showForm ? 
      (
        <VehiculoInversionCreador
          showForm={showForm}
          VehiculoInversion={VehiculoInversionSeleccionado}
          accion={accion}
...
export default VehiculoInversion;
