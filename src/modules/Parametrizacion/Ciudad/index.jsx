...
import {onGetColeccion, onDelete} from '../../../@crema/redux/features/ciudades/ciudadesSlice';
...
const Ciudad = (props) => {
  ...
  const { rows, desde, hasta, ultima_pagina, total } = useSelector((state) => state.ciudades);
