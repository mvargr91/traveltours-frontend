...
import {
  ...
  onCreate,
  resetCiudadActual,
}  from '../../../../@crema/redux/features/ciudades/ciudadesSlice';
...
const validationSchema = yup.object({
  ...
  nombre_departamento: yup.string().required('Requerido'),
});
...
const CiudadCreador = (props) => {
  ...
  const selectedRow = useSelector((state) =>  state.ciudades.ciudadActual);  
  const loading = useSelector((state) =>  state.ciudades.loading);

  const initializeSelectedRow = () => {
    dispatch(resetCiudadActual()); 
  };
  useEffect(() => {
        ...
        <AppScrollbar>
          <Formik
            ...
            initialValues={{
              ...
              nombre_departamento: selectedRow ? selectedRow.nombre_departamento : '',
