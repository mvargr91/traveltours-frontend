...
const PrecioProyectadoForm = (props) => {
          ...
          <Box px = {{md: 5, lg: 8, xl: 10}}>
            ...
            >   
              <MyCurrencyFieldMoneda 
                ...
                className = {classes.myTextField} 
                label = 'Precio comunidad energetica' 
                name = 'precio_comunidad' 
                disabled = {disabled}
                required 
                onChange={(e) => setFieldValue(name, e.target.value)}
              />
              <MyCurrencyFieldMoneda 
                ...
                className = {classes.myTextField} 
                label = 'Precio comercializador PPA' 
                name = 'precio_com_ppa' 
                disabled = {disabled} 
                onChange={(e) => setFieldValue(name, e.target.value)}
              />
            ...
            >   
              <MyCurrencyFieldMoneda 
                ...
                className = {classes.myTextField} 
                label = 'Precio comercializador representado' 
                name = 'precio_com_representado' 
                disabled = {disabled} 
                onChange={(e) => setFieldValue(name, e.target.value)}
              />
            </Box>        
...
PrecioProyectadoForm.propTypes = {
...
export default PrecioProyectadoForm;
