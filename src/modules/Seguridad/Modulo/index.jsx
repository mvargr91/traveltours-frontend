...
const Modulos = (props) => {
  ...
  const { coleccionLigera: aplicaciones } = useSelector((state) => state.aplicaciones);
  useEffect(() => {
  ...
  return (
    <div className={classes.root}>
                          ...
                          {permisos.indexOf('Listar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.ver' />}>
                              ...
                              sx={{'&:hover': {
                                ...
                                onClick={() => onOpenViewModulo(row.id)}></VisibilityIcon>
                            </Tooltip>
                          )}
      ...
      <Popover
        ...
        <Box sx={{color: theme.palette.grayBottoms}} className={classes.popoverColumns}>
