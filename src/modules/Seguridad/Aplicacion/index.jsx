...
const useToolbarStyles = makeStyles((theme) => ({
  ...
  contenedorFiltros: {
    width: '90%',
    display: 'grid',
    gridTemplateColumns: '1fr 1fr', // Dos columnas por defecto
    gap: '20px',
...
const Aplicacion = (props) => {
  ...
  return (
    <div sx={{backgroundColor:theme.palette.primary.main,}} className={classes.root}>
      <Paper 
      ...
      className={classes.paper}>
        ...
        {showTable && permisos ? (
          <Box sx={{backgroundColor: theme.palette.background.paper,}} className={classes.marcoTabla}>
