...
import {onGetExtractos} from '../../../@crema/redux/features/envioExtracto/envioExtractoSlice';
...
const Aplicacion = (props) => {
  ...
  const handleCreateBackup = async () => {
    setLoading(true);
    try {
      const response = await dispatch(onGetExtractos()).unwrap();
  ...
  <Tooltip title='Envio de extractos'>
    <Box
      display="flex"
    ...
    >
      ...
      >
        {loading ? 'Enviando extractos...' : 'Presiona para generar envios'}
      </Typography>
    </Box>
  </Tooltip>
</Box>
