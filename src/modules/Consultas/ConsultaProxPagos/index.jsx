...
import { onGetProxPagos } from '../../../@crema/redux/features/consultaProxPagos/consultaProxPagosSlice';
...
const Inversion = (props) => {
  ...
  useEffect(() => {
    const hayFiltro = fechaDesdeFiltro || fechaHastaFiltro;

    if (!hayFiltro && modoVisualizacion) {
      Swal.fire({
        title: 'Filtros requeridos',
        text: 'Debe especificar al menos un criterio de fecha para la búsqueda.',
  ...
  const queryFilter = (e) => {
    ...
    switch (e.target.name) {
      ...
      case 'inversionistaFiltro':
        setInversionistaFiltro(e.target.value);
        break;
      case 'tipoConceptoFiltro':
        setTipoConceptoFiltro(e.target.value);
        break;
      case 'modoVisualizacion':
        setModoVisualizacion(e.target.value);
        break;
      default:
        break;
    }
