...
import {onGetColeccionProyecto as onGetColeccion, onDelete} from '../../../@crema/redux/features/planDetallado/planDetalladoSlice';
        ...
        <>
          ...
          <Box className={classes.contenedorFiltros}> 
            ...
            <TextField
              ...
              disabled={true}
              onChange={queryFilter}
              value={formatCurrency(rows[0]?.valor_inversion_por_proyecto)}
              className={classes.inputFiltros}
              variant='standard'
              InputProps={{
...
const Inversion = (props) => {
  ...
  const { inversion_id, id_proyecto } = useParams();
  ...
  const onGoBack = () => { 
		navigate('/consulta-inversiones-proyectos');
	}
