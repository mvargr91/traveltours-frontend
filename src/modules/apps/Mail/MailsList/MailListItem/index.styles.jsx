...
export const MailItemWrapper = styled(ListItemButton)((props) => {
  return {
    ...
    backgroundColor: props.mail.isRead
      ?(theme)=>  theme.alpha(props.theme.palette.background.default, 0.8)
    ...
    '&.active': {
      backgroundColor:(theme)=>  theme.alpha(props.theme.palette.primary.main, 0.1),
      boxShadow: (theme)=> `0 3px 5px 0 ${theme.alpha(props.theme.palette.common.black, 0.08)}`,
    },
    '& .avatar': {
      width: 36,
      height: 36,
